...
public class QDepartment extends EntityPathBase<Department> {
    ...
    private static final long serialVersionUID = -1651919151L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QDepartment department = new QDepartment("department");

    public final QEmployee depthead;
    ...
    public QDepartment(Class<? extends Department> type, PathMetadata metadata, PathInits inits) {
        ...
        this.depthead = inits.isInitialized("depthead") ? new QEmployee(forProperty("depthead"), inits.get("depthead")) : null;
    }
